...
If we are not auditing the system, we can enable it with
...
\begin{lstlinsting}[style=AMMA, language=bash]
\end{lstlisting}
...
the security policies on the storage location by running
