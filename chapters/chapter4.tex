...
\being{lstlisting}[style=AMMA, language=bash]
...
should use storage drivers which support this feature.
...
the files need to be read by other containers or the host.
...
\subsection {Default Protections}
