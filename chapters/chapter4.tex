...
Checking which networks are used by a container can be checked using a Docker client
...
can create a new network and restart the container with it by using
